...
public partial class WeirdGun : Gun {
    ...
    public static readonly PackedScene PackedSceneResource = ResourceLoader.Load<PackedScene>("res://source/weapons/WeirdGun.tscn");
...
Reload Speed: {BaseReloadSpeed}
    ...
    protected override BulletInstance BulletInstance() =>
        new(KidoUtils.BulletFrom.Player, BulletSpeed.KindaSlow, Damage);
}
